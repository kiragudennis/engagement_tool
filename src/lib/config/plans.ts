...
export const PLAN_LIMITS: Record<PlanId, PlanLimits> = {
  ...
  pro: {
    maxEngagementsPerMonth: 50000,
    maxSpinGames: 10,
    maxTriviaChallenges: 10,
    maxActiveDraws: 10,
    maxPrizeSlots: 24,
...
export const PLANS: PlanDefinition[] = [
  {
    ...
    features: [
      ...
      { text: "50 trivia questions", included: true },
      { text: "500 sticker codes", included: true },
      { text: "20 public access codes", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "50,000 engagements/month", included: true },
      { text: "24 prize slots on wheel", included: true },
      { text: "200 trivia questions", included: true },
      { text: "1,000 sticker codes", included: true },
      { text: "5,000 POS codes", included: true },
      { text: "30 public access codes", included: true },
      { text: "Viewer prizes (internal streams)", included: true },
      { text: "Bulk code generation", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "500,000 engagements/month", included: true },
      { text: "36 prize slots on wheel", included: true },
      { text: "Unlimited trivia questions", included: true },
      { text: "Unlimited sticker codes", included: true },
...
export const EARLY_BIRD_PACKAGES = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "1,000 sticker codes", included: true },
      { text: "5,000 POS codes", included: true },
      { text: "60 public access codes", included: true },
      { text: "Viewer prizes (internal streams)", included: true },
      { text: "Full branding customization", included: true },
      { text: "Customer CSV + API + Webhooks", included: true },
      { text: "Live broadcast (OBS)", included: true },
